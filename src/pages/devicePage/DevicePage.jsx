      ...
      <div class="relative overflow-x-auto mt-[2rem] px-[7rem] pt-20">
        <div className="flex gap-5 items-center">
          ...
          {isLoadingCreate ? (
            ...
            <button onClick={handleLoadingCreate}
          ...
          <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={index}>
                  ...
                  <td class="px-6 py-4 text-gray-900" key={data.id}>
                    {isRegister === data.id ? (
                      ...
                      <>
                        <button type="button" onClick={() => {handleEdit(data.id)}} className="px-4 py-2 mr-2 w-[5rem] text-white bg-blue-500 rounded hover:bg-blue-700">
                          Edit
                        </button>
                        <button type="button" onClick={() => {handleDelete(data.id)}} className="px-4 py-2 mr-2 w-[5rem] text-white bg-red-500 rounded hover:bg-red-700">
                          Delete
                        </button>
                      </>
                    )}
            ...
            {selectedUser !== "" && loading ? (
              ...
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4 text-gray-900">
                  <button type="button" onClick={() => {handleEdit(userData?.user?.id)}} className="px-4 py-2 mr-2 w-[5rem] text-white bg-blue-500 rounded hover:bg-blue-700">
                    Edit
                  </button>
                  <button type="button" onClick={() => {handleDelete(userData?.user?.id)}} className="px-4 py-2 text-white bg-red-500 rounded hover:bg-red-700">
                    Delete
                  </button>
                </td>
              </tr>
